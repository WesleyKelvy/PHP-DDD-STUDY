...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Modules\Auth\Domain\Gateway\AuthenticatorGateway' => \App\Modules\Auth\Infra\Gateway\LaravelAuth::class,
            'App\Modules\Auth\Domain\Repo\RegisterRepository' => \App\Modules\Auth\Infra\Persistence\EloquentAuthRepository::class,
            'App\Modules\Log\Domain\Repo\LogRepository' => \App\Modules\Log\Infra\Persistence\EloquentLogRepository::class,
            'App\Modules\Payment\Domain\Repo\SaleRepository' => \App\Modules\Payment\Infra\Persistence\EloquentSaleRepository::class,
            'App\Shared\Application\Events\EventDispatcherInterface' => \App\Shared\Infrastructure\Events\LaravelEventDispatcher::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/kelvy/Documents/PROJECTS/PHP-DDD-STUDY/follows-and-followers/public/storage' => 'string',
            ...
            'mercadopago.acess_token' => 'string',
            'mercadopago.webbook_secret' => 'string',
            'mercadopago.price' => 'double',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.email_hash_key','auth.defaults.guard',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/kelvy/Documents/PROJECTS/PHP-DDD-STUDY/follows-and-followers/public/storage','hashing.driver',
'hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.bcrypt.limit','hashing.argon.memory','hashing.argon.threads',
'hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','hashing.argon2id.memory','hashing.argon2id.threads',
'hashing.argon2id.time','hashing.argon2id.verify','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mercadopago.acess_token','mercadopago.webbook_secret',
'mercadopago.price','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'boost.browser-logs','register.view','login.view',
'login','register','logout','payments.create','payments.pending',
'payments.success','webhooks.mercadopago.payment-event','webhooks.mercadopago.notification','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.login','auth.register','components.layout','welcome','laravel-exceptions-renderer::components.badge',
...
'EMAIL_HASH_KEY','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','MP_ACCESS_TOKEN',
'MP_WEBHOOK_SECRET','APP_PRICE',);
